					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Energiekostenschätzung für SWM",
									"targetURL": "#costcalculator-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"costcalculator-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=costcalculator",
									"url": sap.ui.require.toUrl("costcalculator")
								}
							}
						}
					}
